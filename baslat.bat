@echo off
title LLM Trading System - Baslatici
...
echo.
echo +====================================================================+
echo ^|           LLM TRADING SYSTEM - BASLATICI                           ^|
echo ^|                     v2.0.0                                         ^|
echo +====================================================================+
echo.
...
echo  3) Sanal Trading - BTC/USDT (15 dakikalik mumlar)
echo  4) Sanal Trading - Ozellestirilmis
echo  5) Canli Trading (DIKKAT!)
echo  6) Geriye Donuk Test
echo  7) Portfoy Durumu
echo  8) Test Paketi
echo  9) Kayitlari Goster
echo.
echo  0) Cikis
echo.
echo ====================================================================
...
echo.
echo ====================================================================
echo    SANAL TRADING - BTC/USDT (15 Dakikalik Mumlar)
echo ====================================================================
echo.
echo [BILGI] Bot baslatiliyor... (Ctrl+C ile durdurabilirsiniz)
echo.
...
echo.
echo ====================================================================
echo      OZELLESTIRILMIS SANAL TRADING
echo ====================================================================
echo.
set /p custom_symbol="Sembol (orn: BTC/USDT, ETH/USDT): "
set /p custom_interval="Aralik (5m, 15m, 30m, 1h, 4h): "
set /p custom_watchdog="Bekci aktif mi? (e/h): "

echo.
echo [BILGI] Bot baslatiliyor...
echo Sembol: %custom_symbol%
echo Aralik: %custom_interval%
...
set /p live_interval="Aralik (15m, 30m, 1h, 4h): "

echo.
echo [UYARI] CANLI ISLEM BASLATILIYOR!
echo Sembol: %live_symbol%
echo Aralik: %live_interval%
echo.
timeout /t 3 >nul
...
echo.
echo ====================================================================
echo              GERIYE DONUK TEST CALISTIRILIYOR...
echo ====================================================================
echo.
...
echo.
echo ====================================================================
echo              TEST PAKETI CALISTIRILIYOR...
echo ====================================================================
echo.
...
if exist "logs\trading.log" (
    ...
    echo [BILGI] Henuz kayit dosyasi olusturulmadi.
)
echo.
pause
goto MENU
